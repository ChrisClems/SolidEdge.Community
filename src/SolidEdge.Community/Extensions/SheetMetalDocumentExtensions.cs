...
public static class SheetMetalDocumentExtensions
{
    ...
    /// <returns></returns>
    public static Version GetCreatedVersion(this SheetMetalDocument document)
    {
    ...
    /// <param name="document"></param>
    /// <returns></returns>
    public static Version GetLastSavedVersion(this SheetMetalDocument document)
    {
    ...
    /// <param name="document"></param>
    /// <returns></returns>
    public static PropertySets GetProperties(this SheetMetalDocument document)
    {
    ...
    /// <param name="document"></param>
    /// <returns></returns>
    public static SummaryInfo GetSummaryInfo(this SheetMetalDocument document)
    {
    ...
    /// <param name="document"></param>
    /// <returns></returns>
    public static Variables GetVariables(this SheetMetalDocument document)
    {
